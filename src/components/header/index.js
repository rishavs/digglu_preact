		...
		return (
			<header class="w-100 dt pa3 ph5-ns bg-near-black">
				...
				<nav class="dc dtc v-mid w-100 tr">
					<a class="f6 fw6 dim link light-gray mr1 mr3-m mr4-l dib" href="#">Docs</a>
					<a class="f6 fw6 dim link light-gray mr1 mr3-m mr4-l dib" href="#">Componets</a>
					<a class="f6 link dim br2 ba bw1 ph3 pv2 mb2 dib light-gray" href="#0">Signup</a>
					<a class="f6 fw6 dim link light-gray mr1 mr3-m mr4-l dn dib" href="#">Login</a>
				</nav>
			</header>
		);
	}
